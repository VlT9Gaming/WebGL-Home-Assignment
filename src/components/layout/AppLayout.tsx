...
export function AppLayout() {
  ...
  return (
    <div className="app-shell py-3 md:py-5">
      <header className="site-header relative overflow-hidden border-slate-200/80 bg-linear-to-br from-white via-slate-50 to-indigo-50 shadow-sm">
        ...
        <div className="account relative rounded-xl border border-slate-200 bg-white/85 p-3">
          {user ? (
            ...
            <small className="text-slate-600">Sign in with your account.</small>
          )}
        </div>
      </header>
